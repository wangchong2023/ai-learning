...
> 
> 本篇包含第 1~2 章。这是构建 AI 认知大厦的钢筋混凝土。
>
...
> 
> *   **Phase 1 (1.4.5)**：**逻辑起点** —— 编写 Argo 的第一个结构化 Prompt。
...
> [!NOTE]  
> **教学主线：Argo (阿耳戈) 计划**  
> 为了确保代码风格的一致性，本文档将以一个名为 **Argo** 的“企业级深度调研智能体”为演进主线。您将见证它从一个简单的 Prompt（1.4.5），进化为一个具备工具调用能力的单体 Agent（11.2），最终成长为支持多步推理、并行搜索与自反思的深度研究系统（11.6）。
...
#### 1.4.1 模型微观地基
> [!NOTE]  
> **小白逃生通道**：本节涉及较多底层数学原理。如果你并非算法工程师，或更关注“如何使用和部署 AI”，**可以安全地跳过本节**，直接从 [**1.4.5 交互与增强**](#145-交互与增强) 开始阅读。这不会影响你对后续工程架构的理解。
...
#### 11.2.6 Plan-and-Execute模式 [Build]
